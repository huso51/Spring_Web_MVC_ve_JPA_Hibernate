...
//	http://localhost:8080/{}/{soyadi}/{email}.xml
	@RequestMapping(value = "/{adi}/{soyadi}/{email}.xml", 
...
//	http://localhost:8080/{adi}/{soyadi}/{email}.json
	@RequestMapping(value = "/{adi}/{soyadi}/{email}.json", 
			method = RequestMethod.GET,  
...
//	http://localhost:8080/xml/personel
	@RequestMapping(value = "/personel.xml", 
			method = RequestMethod.GET,  
			produces = "application/xml; charset=UTF-8")
	public PersonelList uretxml2(){	
		List<Personel> personeller = personelDAO.list();
		/*
		Personel p1 = new Personel("adi1", "soyadi1", "email1");
		Personel p2 = new Personel("adi2", "soyadi2", "email2");
		Personel p3 = new Personel("adi3", "soyadi3", "email3");
		personeller.add(p1);
		personeller.add(p2);
		personeller.add(p3);
		*/
...
//	http://localhost:8080/json/personel
	@RequestMapping(value = "/personel.json", 
			method = RequestMethod.GET,  
			produces = "application/json; charset=UTF-8")
...
//	http://localhost:8080/xml/personel/2
	@RequestMapping(value = "/personel/{id}.xml", 
			method = RequestMethod.GET,  
			produces = "application/xml; charset=UTF-8")
...
//	http://localhost:8080/json/personel/2
	@RequestMapping(value = "/personel/{id}.json", 
			method = RequestMethod.GET,  
			produces = "application/json; charset=UTF-8")
